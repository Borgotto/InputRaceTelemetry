...
class CustomFigCanvas(FigureCanvas, TimedAnimation):
    def __init__(self):
        ...
        self.line2 = Line2D([], [], color='red', linewidth=5)
        self.line2_tail = Line2D([], [], color='red', linewidth=5)
        self.line2_head = Line2D([], [], color='red', linewidth=5 )
...
def dataSendLoop(addData_callbackFunc):
    ...
    mySrc2 = Communicate()
    mySrc2.data_signal.connect(addData_callbackFunc)
